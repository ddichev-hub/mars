...
---
cliconf: saos8x
short_description: Use saos6x cliconf to run command on CIENA SAOS 8x platform
description:
  - This saos6x plugin provides low level abstraction apis for
    sending and receiving CLI commands from CIENA SAOS 8x network devices.
version_added: "0.1"
"""
